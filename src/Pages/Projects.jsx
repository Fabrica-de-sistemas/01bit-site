...
const Projects = () => {
  return (
    <>
      <section id="projects" className="mt-20 bg-secondary-03 py-10 px-5">
        <h2 className="text-center font-bold text-[28px] text-grayColors-01 mb-8">
          Our Projects
        </h2>
        <div
          className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center gap-10 px-2"
        >
          <div className="w-full lg:w-[25%] text-center text-grayColors-01">
            <div className="mb-7">
              <h4 className="font-bold text-base mb-1">E-commerce</h4>
              <p className="font-normal text-[14px] mb-2 max-w-[28ch] mx-auto">
              ...
              <p className="font-normal text-[14px] mb-2 max-w-[25ch] mx-auto">
