...
const ContactUs = () => {
  return (
    <>
      <section
  id="contact"
  className="flex flex-col md:flex-row mt-20 mx-auto w-full md:w-[80%] bg-otherColors-01 shadow-boxShadow rounded-3xl py-10 px-5 md:px-10 gap-10 md:gap-10"
  >
  <div className="w-full md:w-[48%] bg-primary-03 text-grayColors-01 rounded-3xl px-8 py-6 flex flex-col">
