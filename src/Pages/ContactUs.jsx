    ...
    <div id="contact">
      <section className="grid lg:hidden mt-20 screen320px:w-[301px] screen414px:w-[361px] mx-auto bg-otherColors-01 shadow-boxShadow rounded-3xl py-10 screen414px:px-[30px]">
        ...
        <form
          ...
          className="grid justify-center max-w-lg mx-auto p-3"
        >
          <div>
            <input
              type="text"
              placeholder="Primeiro nome"
              className="w-full p-2 rounded-lg border-1 border border-secondary-02 border-opacity-30 text-secondary-02 placeholder-secondary-02 placeholder-opacity-30 focus:outline-none focus:border-primary-02"
              {...register('firstName', {
            ...
            />
            {errors?.firstName && (
              <p className="text-xs text-nowrap text-otherColors-02 text-left mt-1 font-light ml-2">
          ...
          <div className="mb-10">
            ...
            <textarea
              id="description"
              className="w-full p-2 px-1 rounded-lg border border-secondary-02 border-opacity-30 text-secondary-02 focus:outline-none focus:border-primary-02"
              {...register('message', {
      ...
      <section className="hidden lg:flex flex-col lg:flex-row mt-20 mx-auto w-full lg:w-[900px] bg-otherColors-01 shadow-boxShadow rounded-3xl py-10 px-5 lg:px-10 gap-10  lg:gap-10 relative">
